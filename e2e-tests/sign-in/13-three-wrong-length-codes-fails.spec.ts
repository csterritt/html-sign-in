import { Page, test } from '@playwright/test' // UNREVIEWED
...
const doOneBadTry = async (page: Page) => {
  await fillInput(page, 'code', '5656')
...
test('submitting three wrong magic codes, even of the wrong length, fails and you have to start over', async ({
  page,
}) => {
